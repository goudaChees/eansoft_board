                            	...
                            	<hr>
                            		<div class="" id="lists">
										<c:forEach var='ii' items="${list }">
											...
											<div class='col-4 body2 ellipsis' style='border-right : 0.125rem solid #DFE3E8;'><a class="ellipsis" href="/board/viewContents?seq=${ii.seq}">${ii.title} [${ii.reply_count}]</a></div>
